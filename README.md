...
|owner_user          |string |No                                       |The email address of existing user who will be primary owner of property.                   |                                                                     If no owner_user set, the user_email from authentication will become the owner.                                                                                                           |
